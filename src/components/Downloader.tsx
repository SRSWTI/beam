// TODO: UX - Add download speed indicator (MB/s)
// TODO: UX - Show estimated time remaining for downloads
// TODO: Accessibility - Add screen reader announcements for download progress
    ...
    <>
      ...
      <div className="bg-stone-50 dark:bg-stone-900 border border-stone-200 dark:border-stone-700 rounded-lg p-8 max-w-md w-full">
        ...
        <div className="space-y-4 text-stone-700 dark:text-stone-300">
          <p>
            Bodega Beam uses direct peer-to-peer connections, but sometimes the
            uploader&apos;s browser needs a moment to establish the connection with
            yours.
          </p>
          ...
          <ul className="list-none space-y-3">
            <li className="flex items-start gap-3 px-4 py-2 rounded-lg bg-stone-100 dark:bg-stone-800">
              ...
              <span className="text-sm">
                ...
                or stopped the upload. Bodega Beam requires the uploader to stay
