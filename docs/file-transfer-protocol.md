# Bodega Beam File Transfer Protocol

This document explains the message-based protocol that Bodega Beam uses to
...
flowchart LR
    ...
    Uploader -- REST --> Server[(Bodega Beam Server)]
...
uploader or downloader for Bodega Beam or adapt the protocol for other
applications.
